...
public class Attendance
{
    ...
    public void submitAttendance(final OnAttendanceSubmitListener listener, final Attendance attendance, final String userKey, final String standard)
    {

        final DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference();
        dbRef.getRoot();
        final String attendanceKey = dbRef.child("attendance").child(userKey).child(standard).push().getKey();

        final Map<String, Object> postData = new HashMap<>();
        postData.put("/attendance/" + userKey + "/" + standard + "/" + attendanceKey + "/", attendance.toMap());
    ...
    interface OnAttendanceSubmitListener
    {
